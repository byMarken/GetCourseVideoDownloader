...
> Сборка подписывается через **SignPath Foundation** (бесплатно для open-source), если в настройках репозитория заданы секреты `SIGNPATH_*`. Тогда в окне SmartScreen будет показан издатель вместо «Неизвестный издатель».
