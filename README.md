...
| **PLAYLIST_URL** | Ссылка на страницу с уроками (stream) GetCourse. Пример: `https://school.example/teach/control/stream/view/id/343098743`.  |
...
PLAYLIST_URL=https://school.example/teach/control/stream/view/id/343098743
```
